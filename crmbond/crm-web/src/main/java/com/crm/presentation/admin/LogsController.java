...
import com.crm.sessionbean.LogsFacade;
...
public class LogsController implements Serializable {
	...
	@EJB
	private com.crm.sessionbean.LogsFacade ejbFacade;
	private List<InteractionLogs> items = null;
	private InteractionLogs selected;

	public LogsController() {
	}

	public InteractionLogs getSelected() {
		return selected;
	}

	public void setSelected(InteractionLogs selected) {
	...
	public InteractionLogs prepareCreate() {
		selected = new InteractionLogs();
	...
	public List<InteractionLogs> getItems() {
		if (items == null) {
	...
	public InteractionLogs getLogs(java.lang.Integer id) {
		return getFacade().find(id);
	}

	public List<InteractionLogs> getItemsAvailableSelectMany() {
		return getFacade().findAll();
	}

	public List<InteractionLogs> getItemsAvailableSelectOne() {
		return getFacade().findAll();
	}

	@FacesConverter(forClass = InteractionLogs.class)
	public static class LogsControllerConverter implements Converter {
		...
		public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
			...
			if (object instanceof InteractionLogs) {
				InteractionLogs o = (InteractionLogs) object;
				return getStringKey(o.getId());
			} else {
				LOG.error( "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), InteractionLogs.class.getName()});
				return null;
			}
		}
